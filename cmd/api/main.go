...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "211353@astanait.edu.kz", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "secret password", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <211353@astanait.edu.kz>", "SMTP sender")
